    ...
    if CFG.train:
        ...
        for fold in range(CFG.n_fold):
            if fold in CFG.trn_fold:
                ...
                annotations_.to_pickle(os.path.join(OUTPUT_DIR, 'annotations.pkl'))
                predictions_.to_pickle(os.path.join(OUTPUT_DIR, 'predictions.pkl'))
        ...
        annotations.to_pickle(os.path.join(ROOT_DIR, 'annotations.pkl'))
        predictions.to_pickle(os.path.join(ROOT_DIR, 'predictions.pkl'))
