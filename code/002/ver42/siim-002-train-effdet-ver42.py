...
def inference(valid_loader, models, device, iou_thr):
    ...
    for step, (image_ids, images, targets) in tk0:
        ...
        for i in range(images.shape[0]):
            boxes, scores, labels = run_nms(predictions_temp, image_index=i, iou_thr=iou_thr, skip_box_thr=0.01)
...
def train_loop(folds, fold):
    ...
    test_loader = DataLoader(test_dataset,
                                **CFG.loader_params['valid'],
                                collate_fn=collate_fn)
    predictions = inference(test_loader, models, device, iou_thr=0.55)
