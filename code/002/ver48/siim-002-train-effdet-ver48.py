...
class CFG:
    ...
    model_pretrained_weight = os.path.join(ROOT_DIR, 'input/efficientdet/efficientdet_d7-f05bf714.pth')
    target_size = 1
...
train = train[train['detection_label'] == 1].reset_index(drop=True)
...
for n, (train_index, valid_index) in enumerate(Fold.split(folds, folds[CFG.target_col], groups=folds[CFG.split_col])):
